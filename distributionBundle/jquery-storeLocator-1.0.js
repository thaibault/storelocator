    ...
    StoreLocator = (function(_super) {
      ...
      StoreLocator.prototype.initializeMap = function() {
        ...
        window.google.maps.event.addListener(searchBox, 'places_changed', (function(_this) {
          return function() {
            var distanceInMeter, foundPlace, marker, matchingMarker, shortestDistanceInMeter, _k, _len1, _ref2;
            foundPlace = _this.determineBestSearchResult(searchBox.getPlaces());
            if (foundPlace != null) {
      ...
      StoreLocator.prototype.determineBestSearchResult = function(candidates) {
        ...
        /*
            ...
            will be preferred.
         */
        var candidate, distanceInMeter, result, shortestDistanceInMeter, _i, _len, _ref;
        result = null;
        if (candidates.length) {
          shortestDistanceInMeter = window.Number.MAX_VALUE;
          for (_i = 0, _len = candidates.length; _i < _len; _i++) {
            candidate = candidates[_i];
            if (((_ref = candidate.geometry) != null ? _ref.location : void 0) != null) {
              ...
              this.critical('Found place "{1}" doesn\'t have a location. ' + 'Full object:', candidate.name);
